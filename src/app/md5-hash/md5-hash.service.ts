...
export class Md5HashService {
  ...
  getWorkerScriptAsString(): string {
    return '// Contents of spark-md5.min.js from  https://github.com/satazor/SparkMD5\n' +
      ...
      '\n' +
      '// Below worker code is based on https://www.codeproject.com/Articles/830704/Gigabit-File-uploads-Over-HTTP\n' +
      '\n' +
